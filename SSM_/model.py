...
class SSM5(Base):
    def __init__(self, args, device):
        ...
        # self.x_loss_cls = CrossEntropy(self.posterior_s, self.decoder_s)
...
class SSM7(Base):
    def __init__(self, args, device):
        ...
        self.s_loss_cls = KullbackLeibler(self.posterior_s, self.prior_s)  # TODO: 自分で書いてみる
        self.ss_loss_cls = KullbackLeibler(self.posterior_ss, self.prior_ss)  # TODO: 自分で書いてみる
        self.optimizer = optim.Adam(self.distributions.parameters())
