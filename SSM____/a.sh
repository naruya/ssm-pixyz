CUDA_VISIBLE_DEVICES=3 OMP_NUM_THREADS=16 python train.py --model SSM16 --s_dim 64 --resume --resume_name Jan18_09-52-29_SSM16_s64_40ce024_base --resume_itr 1352000 --resume_epoch 1001 --resume_time aaa --epochs 2000
